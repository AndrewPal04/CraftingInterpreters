...
class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Object visitBinaryExpr(Expr.Binary expr) {
        ...
        switch (expr.operator.type) {
            ...
            case PLUS:
                ...
                // Allow string + number concatenation
    ...
    // CHALLENGE 1 (Chapter 6): Comma operator evaluation
    @Override
    public Object visitCommaExpr(Expr.Comma expr) {
        evaluate(expr.left);  // Evaluate but discard left value
        return evaluate(expr.right);  // Return right value
    }

    // CHALLENGE 2 (Chapter 6): Ternary operator evaluation
    @Override
